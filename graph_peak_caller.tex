...
In the Github repository at \url{http://github.com/uio-bmi/graph_peak_caller}, we provide a simple tutorial on how to use vg and Graph Peak Caller to go from raw ChIP-seq reads to peaks. 
...
\bibitem{devoreberk}
  Devore J, Berk K. Modern Mathematical Statistics with Applications.
