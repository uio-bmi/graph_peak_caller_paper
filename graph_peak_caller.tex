...
\\
Ivar Grytten\textsuperscript{1,2\Yinyang*},
Knut D. Rand\textsuperscript{2,3\Yinyang},
Alexander J. Nederbragt\textsuperscript{1,2,4},
Geir O. Storvik\textsuperscript{2,3},
Ingrid K. Glad\textsuperscript{2,3},
Geir K. Sandve\textsuperscript{1,2}, 
\\
\bigskip
\textbf{1} Department of informatics, University of Oslo, Oslo, Norway
\\
\textbf{2} Centre for Computational Inference in Evolutionary Life Science, Faculty of Mathematics and Natural Sciences, University of Oslo, Oslo, Norway
\\
\textbf{3} Department of Mathematics, University of Oslo, Oslo, Norway
\\
\textbf{4} Department of Biosciences, University of Oslo, Oslo, Norway
\\
\bigskip
...
Raw ChiP-seq reads were downloaded from the NCBI Sequence Read Archive (SRA) (SRA accession numbers in S1 Appendix) and trimmed using \emph{Trim Galore!} v0.4.4~\cite{trim_galore} (default parameters).
Reads were mapped both to our graph-based reference genome using vg and to the \emph{Tair10}~\cite{tair} reference genome using \emph{BWA} v0.7.12 (\texttt{bwa aln} followed by \texttt{bwa samsse}, default parameters).
