...
\caption{Overview of peaks reported by Graph Peak Caller and MACS2 on \emph{A. thaliana} for 5 transcription factors (TFs).
  ...
  \emph{shared} is the number of peaks that overlap with one or more peaks from the other peak caller,
...
\begin{figure}[H] \frame{ \includegraphics[width=1.0\textwidth]{figures/Fig2.png} }
