...
\begin{table}[!ht]
\begin{adjustwidth}{-2.45in}{0in} % Comment out/remove adjustwidth environment if table fits in text column.
\centering
...
\label{table1}
\begin{tabularx}{1.55\textwidth}{Xbcdbcdbb}
\toprule
